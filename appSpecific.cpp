...
RCactive~1~3~C~Enable remote control
servoSteerPin~~4~N~Pin used for steering servo
motorRevPin~2~4~N~Pin used for motor direction (PWM+DIR mode)
motorFwdPin~1~4~N~Pin used for motor PWM (PWM+DIR mode)
...
pwmFreq~20000~4~N~RC Motor PWM frequency
...
minDutyCycle~5~4~N~Min motor duty cycle % (stop)
